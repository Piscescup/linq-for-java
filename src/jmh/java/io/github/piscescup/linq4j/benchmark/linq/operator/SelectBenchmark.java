...
public class SelectBenchmark {
    ...
    public Object mineSimple() {
        return mine.select(BenchmarkData.Person::getId).toList();
    }

    @Benchmark
    public Object referenceSimple() {
        return reference.select(BenchmarkData.Person::getId).toList();
    }

    @Benchmark
    public Object mineComplex() {
        return mine.select(BenchmarkFunctions::complexProjection).toList();
    }

    @Benchmark
    public Object referenceComplex() {
        return reference.select(BenchmarkFunctions::complexProjection).toList();
    }
}
