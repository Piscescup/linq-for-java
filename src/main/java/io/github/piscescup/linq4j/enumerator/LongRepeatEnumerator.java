...
/**
 * An enumerator that returns the specified primitive {@code long} value
 * a fixed number of times.
 *
 * @author REN YuanTong
 * @since 1.0.0
 */
public final class LongRepeatEnumerator implements LongEnumerator {
    ...
    public LongRepeatEnumerator(long element, int count) {
