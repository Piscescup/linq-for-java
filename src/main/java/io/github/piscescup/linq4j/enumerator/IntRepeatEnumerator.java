...
/**
 * An enumerator that returns the specified primitive {@code int} value
 * a fixed number of times.
 *
 * @author REN YuanTong
 * @since 1.0.0
 */
public final class IntRepeatEnumerator implements IntEnumerator {
    ...
    public IntRepeatEnumerator(int element, int count) {
